window.addEventListener('load', function(){
    ...
    class UI {
        ...
        draw(context){
            ...
            // score
            context.fillText('Score: ' + this.game.score, 150, 580);            
            // ammo
    ...
    class Game {
        constructor(width, height){
            ...
            this.ammoTimer = 0;
            // time skill recovery
            this.ammoInterval = 3000;
            this.gameOver = false;
            this.score = 0;
            this.winningScore = 25;
            this.gameTime = 0;
            this.timeLimit = 500000000000;
        }
        update(deltaTime){

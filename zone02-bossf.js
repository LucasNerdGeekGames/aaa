        ...
        draw(context){
            ...
            if (this.game.gameOver){
                ...
                if (this.game.win > this.game.winningScore){
                    ...
                    window.location.href="index3f.html";
                }
                ...
                this.player.projectiles.forEach(projectile => {
                    if (this.checkCollision(projectile, enemy)){
                        ...
                        if (enemy.lives <= 0){
                            ...
                            this.score = localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; 
                            // xp only boss
                            localStorage.xp++;
                            //this.score = localStorage.gold++;

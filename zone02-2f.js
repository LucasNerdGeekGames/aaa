                ...
                this.player.projectiles.forEach(projectile => {
                    if (this.checkCollision(projectile, enemy)){
                        ...
                        if (enemy.lives <= 0){
                            enemy.markedForDeletion = true;
                            this.win++;
                            this.score = localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; localStorage.gold++; 
                            // xp only boss
                            localStorage.xp++;
                            //this.score = localStorage.gold++;

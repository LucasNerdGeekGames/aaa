window.addEventListener('load', function(){
    ...
    class Player {
        ...
        shootTop(){
            ...
            this.projectiles.push(new Projectile(this.game, this.x + 180, this.y + 28));
            this.game.ammo--;
            this.frameX = 2.5 ;
            }
        }
        ...
        update(deltaTime){
            ...
            this.enemies2.forEach(enemy2 => {
                ...
                if (this.checkCollision(this.player, enemy2)){
                    enemy2.markedForDeletion = false;
                    //this.score--;
                    this.gameTime += 5000000000;
